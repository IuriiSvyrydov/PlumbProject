        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Clients = table.Column<int>(type: "int", maxLength: 200, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1/9/2024", "Projects", null },
                    { 2, "1/9/2024", "SiteWorks", null }
                });

            migrationBuilder.InsertData(
                table: "ContactUs",
                columns: new[] { "Id", "Call", "CreateDate", "Email", "Location", "Map", "UpdateDate" },
                values: new object[] { 1, "123-456-789", "1/9/2024", "test@test.com", "Kharkiv", "link is here", null });

            migrationBuilder.InsertData(
                table: "HomePages",
                columns: new[] { "Id", "CreateDate", "Description", "Header", "UpdateDate", "VideoLink" },
                values: new object[] { 1, "1/9/2024", " Test Description 1", " Test Header 2", null, "test video link" });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "CreateDate", "Description", "Icon", "Name", "UpdateDate" },
                values: new object[] { 1, "1/9/2024", " test Description", "bi bi-icon", "test service", null });

            migrationBuilder.InsertData(
                table: "SocialMedias",
                columns: new[] { "Id", "CreateDate", "FaceBook", "Instagram", "LinkedIn", "Twitter", "UpdateDate" },
                values: new object[] { 1, "1/9/2024", "testFaceBook", "testInstagram", null, null, null });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "Id", "CreateDate", "FaceBook", "FileName", "FileType", "FullName", "Instagram", "LinkedIn", "Title", "Twitter", "UpdateDate" },
                values: new object[] { 1, "1/9/2024", "testFacebook", "test", "test", "ferro5", "testInstagram", null, "test", null, null });

            migrationBuilder.InsertData(
                table: "Testimonials",
                columns: new[] { "Id", "Comment", "CreateDate", "FileName", "FileType", "FullName", "Title", "UpdateDate" },
                values: new object[] { 1, "test Comment", "1/9/2024", "test", "test", "ferro5", "test", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 5, "1/9/2024", " is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. ", "test", "test", 3, "Lorem isoum dolor sit amet", 150, 5, 1, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "1/9/2024", "test", "test", "test title", null },
                    { 2, 2, "1/9/2024", "test2", "test2", "test title2", null }
                });
